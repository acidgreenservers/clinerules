---
description: (TO BE USED WITH reflective-developer.md) Enforces architectural integrity by requiring formal review of user requests that contradict established system patterns, leveraging ADRs for transparent decision history. 
author: https://www.google.com/search?q=https://github.com/lucaskara version: 1.0 (Complements Genesis Protocol) 
tags: ["architecture", "guardrail", "technical-debt", "adr", "patterns", "agency"] 
globs: ["memory-bank/systemPatterns.md", "memory-bank/consolidated_learnings.md"]
---
